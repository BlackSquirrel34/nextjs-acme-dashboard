...
export default function EditInvoiceForm({
  ...
  // We're usi and pass that to server action, because:
  // Passing an id as argument won't work, e.g., <form action={updateInvoice(id)}></form>
              ...
              {state.errors && (
                ...
                state.errors.customerId && state.errors.customerId.length > 0) ? (
                  <p className="mt-2 text-sm text-red-500">
                    There is a field missing. We could not create the form.
                  </p>
                ) : null
              )}
            </div>
